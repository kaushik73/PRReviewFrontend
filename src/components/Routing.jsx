...
const Routing1 = ({ stories, handleFormSubmit, handleFillReviewerForm }) => {
      ...
      <Router>
        <div className="min-h-screen p-6 bg-gray-50">
          <header className="flex justify-between items-center mb-4 bg-slate-400 p-4 border-2 rounded-xl">
            ...
            <span onClick={() => openLoginForm()} className="text-blue-600">
              Login
            </span>
          </header>
          ...
          <Routes>
            ...
            <Route
              path="/"
              element={<Navigate to="/story-reviewers-table" />}
            />
          </Routes>
        </div>
      </Router>
